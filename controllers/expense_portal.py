...
class ExpensePortal(CustomerPortal):
    def _prepare_portal_layout_values(self):
        ...
        values["expense_count"] = request.env["hr.expense"].search_count([("employee_id", "=", employee.id)])
        return values
    ...
    def portal_my_expenses(
        ...
        return request.render("demo_unamur.portal_my_expenses", values)
    ...
    def portal_my_expense(self, expense_id, access_token=None, **kw):
        ...
        return request.render("demo_unamur.portal_my_expense", values)
